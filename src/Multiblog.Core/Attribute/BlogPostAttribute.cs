    ...
    public class BlogPostAttribute : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext actionExecutingContext)
        {
            if (actionExecutingContext.RouteData.Values["tenant"] is BlogItem)
            {
                ...
                if (actionExecutingContext.ActionArguments.ContainsKey("slug"))
                {
                    ...
                    actionExecutingContext.Result = ((Controller)actionExecutingContext.Controller)
                        .RedirectToAction(actionExecutingContext.RouteData.Values["action"] as string, "Gallery", actionExecutingContext.RouteData.Values);                        
                }
            }
