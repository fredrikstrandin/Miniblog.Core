...
namespace IdentityServer4.MongoDB.Generator
{
    /// <summary>
    ...
    public class TenantAuthorizeInteractionResponseGenerator : IAuthorizeInteractionResponseGenerator
    {
        /// <summary>
        /// The logger.
        /// </summary>
        ...
        public TenantAuthorizeInteractionResponseGenerator(
            ISystemClock clock,
